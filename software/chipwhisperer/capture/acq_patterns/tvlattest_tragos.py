...
class AcqKeyTextPattern_TVLATTest_Tragos(AcqKeyTextPattern_Base):
    ...
    def init(self, maxtraces):
        ...
        if length <= 32:
            ...
            self._key_gen = util.hexStrToByteArray("12 34 56 78 9a bc de f1 23 45 67 89 ab cd ef 02 34 56 78 9a bc de f0 13 45 67 89 ab cd e0 f0 12")[:length]
        else:
    ...
    def new_pair(self):
        ...
        if group1:
            ...
            for i in range(1, rounds+1):
                exp_key.extend(key_schedule_rounds(list(self._key_gen), 0, i))
